...
The input `Π a : a . a ➔ ☆` can be generated by LiftingType rules, but due to previous shift/reduce conflict it is not parsed. Next is the output of the a parser run in debug mode for this input:
